    ...
    <div class="flex max-sm:flex-col relative ">
        <div class=" w-[20%] max-sm:w-full flex flex-col gap-5 justify-center items-center rounded-lg mt-[1rem] h-[40rem] bg-[#1c1c1d]">
            ...
            <div class="w-[95%] flex flex-col gap-3">
                <div class="flex  h-[60px] text-[#e7e9ec]  rounded-lg hover:bg-[#3b3d3e] hover:duration-100 items-center  gap-3">
                    <x-iconpark-clothescardigan-o class="bg-[#4f5151] p-2 ml-5 rounded-full h-[40px]" />
                    <div class="font-semibold">fashions</div>
                </div>
                <div class="flex  h-[60px] text-[#e7e9ec]  rounded-lg hover:bg-[#3b3d3e] hover:duration-100 items-center  gap-3">
                    <div class=" bg-[#4f5151] ml-5 p-2 flex justify-center items-center rounded-full"><x-hugeicons-computer-programming-01 class="   " /></div>
                ...
                <div class="flex  h-[60px] text-[#e7e9ec]  rounded-lg hover:bg-[#3b3d3e] hover:duration-100 items-center  gap-3">
                    ...
                    <div class="font-semibold">Houses</div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4 w-[80%]">
            @foreach ($products as $product)
            <div class="relative">
                <!-- Condition with red background and positioned at top right -->
